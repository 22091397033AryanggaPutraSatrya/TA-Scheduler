    ...
    <div class="flex items-center justify-center min-h-screen">
        <div class="relative flex flex-col m-6 space-y-8 bg-white shadow-2xl rounded-2xl md:flex-row md:space-y-0">
            ...
            <div class="relative flex flex-col justify-center p-8 text-white bg-primary rounded-2xl md:w-[450px]">
                <div class="z-10">
                    <h1 class="text-4xl font-bold mb-3 tracking-wide">Selamat Datang Kembali!</h1>
                    <p class="font-light max-w-sm">
                        Masuk untuk melanjutkan proses bimbingan tugas akhir Anda.
                    </p>
                </div>
            ...
            <div class="flex flex-col justify-center p-8 md:p-14">
                <span class="mb-3 text-4xl font-bold text-primary">Masuk ke Akun</span>
                ...
                <form action="{{route('login')}}" method="POST">
                    ...
                    <div class="flex justify-between w-full py-4">
                        <div class="mr-24">
                            <input type="checkbox" name="remember" id="remember" class="mr-2 accent-primary">
                            <label for="remember" class="text-md font-light text-gray-600">Ingat Saya</label>
                        </div>
                        <a href="#" class="font-medium text-sm text-primary hover:underline">Lupa Password?</a>
                    </div>
