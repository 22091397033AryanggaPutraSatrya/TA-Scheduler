<aside class="w-full md:w-64 bg-primary text-white p-6 flex flex-col">
    <div>
        ...
        <nav class="space-y-2 mt-8">
            ...
            <a href="{{ route('mahasiswa.draft.index') }}" class="flex items-center space-x-3 px-4 py-3 rounded-lg transition {{ request()->routeIs('mahasiswa.draft.index') ? 'bg-white/20' : 'hover:bg-white/10' }}">
